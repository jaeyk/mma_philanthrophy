...
scripts <- c(
  file.path("src", "01_build_foundation_universe.R"),
  file.path("src", "01b_scrape_foundation_texts.R"),
  file.path("src", "01c_diagnose_scrape_failures.R"),
  file.path("src", "02_classify_focus.R"),
  file.path("src", "02b_score_democracy_state_capacity.R"),
  file.path("src", "02c_score_taie_constructs.R"),
  file.path("src", "03_analyze_spatial_financial_inequality.R")
)
