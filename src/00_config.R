...
path_pipeline <- file.path(project_root, "src")
...
file_construct_taxonomy <- file.path(path_pipeline, "democracy_state_capacity_keywords.csv")
file_construct_scores <- file.path(path_intermediate, "foundation_construct_scores.csv.gz")
file_manual_label_template <- file.path(path_pipeline, "manual_labels_democracy_state_capacity_template.csv")
file_taie_taxonomy <- file.path(path_pipeline, "tech_ai_innovation_entrepreneurship_keywords.csv")
file_taie_scores <- file.path(path_intermediate, "foundation_taie_scores.csv.gz")
file_issue_taxonomy <- file.path(path_pipeline, "issue_focus_keywords.csv")
